    ...
    >
      ...
      <div className="p-5 space-y-2">
        ...
        <div className="pt-4 mt-2 border-t border-neutral-50 flex flex-col gap-1">
           ...
           <div className="flex items-center justify-between">
             <span className="text-[8px] text-neutral-400 uppercase tracking-widest font-bold">DB ID Ref</span>
             <span className="text-[8px] text-luxury-gold font-mono uppercase">{product._id.substring(0, 12)}...</span>
           </div>
        </div>
      </div>
    </motion.div>
